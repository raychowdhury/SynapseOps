                ...
                <div className="container">
                    ...
                    <div className="mb-10">
                        ...
                        <div className="flex gap-3 mt-4">
                            <a href="/services/saas-notifications/channels">
                                <Button variant="outline" size="sm">Configure Channels</Button>
                            </a>
                            <a href="/services/saas-notifications/workflow-builder">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {channelsLoading ? (
                                        ...
                                        <p className="text-text-2 text-sm">No channels configured. <a href="/services/saas-notifications/channels" className="text-primary-light underline">Add one now</a>.</p>
                                    ) : (
